...
async function runChat(userInput) {
  ...
  const model = genAI.getGenerativeModel({ model: MODEL_NAME,
    systemInstruction: "You are a chabot designed for students to ask any kind of queries they might have regarding academics. Help them with clear and precise answers.",
   });
